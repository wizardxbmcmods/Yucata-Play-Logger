		  ...
		  if (xhr.readyState == 4) {
			...
			function myListener(tabId, info, tab) {
				if (info.status == "complete") {
					...
					chrome.tabs.executeScript(tab.id, { code: "window.onready;document.body.appendChild(document.createElement('script')).src='https://rawgit.com/dazeysan/SPLU/master/Source%20Code/SPLU-Current.js'" }, null);
					// end of splu script
